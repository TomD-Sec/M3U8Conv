...
input_file_button = tk.Button(root, text="Select Input Files", command=select_input_file)
...
select_music_button = tk.Button(root, text="Select Music Folder", command=select_music_folder)
